              ...
              <div class="col-9">
                ...
                <div class="row">
                  ...
                  <div class="col-8 projectDetailItem">
                    ...
                    {{ projectDataReceive.endDateSummry }} ( {{ periodWork }} 일
                    )
                  </div>
                </div>
                <div class="row">
    ...
    <div :id="applyModalCtnr" class="d-none applyModalCtnr">
      <div id="applyModal">
        <div :id="leftApply">
          ...
          <button @click="clickApply" id="ApplyOk" class="ProjectApplyBtn mx-2">
            네
          </button>
          <button
            @click="clickNoApply"
            id="ApplyNotYet"
            class="ProjectApplyBtn mx-2"
          >
            아니요
          </button>
        </div>
