              ...
              <div class="contractCtnr" :id="contractImg">
                ...
                <div class="text-start mt-5 container align-items-start">
                  <div contenteditable="false" class="d-flex">
                    <div :id="contractInputItem" class="contractInput d-inline-block"></div>
                  ...
                  <div contenteditable="false" class="d-flex" style="margin-left : 30px;">
                    ...
                    <div :id="contractInputItem" class="contractInput d-inline-block" style="width : 250px"></div>
                  ...
                  <div contenteditable="false" class="d-flex" style="margin-left : 30px;">
                    ...
                    <div :id="contractInputItem" class="contractInput d-inline-block" style="width : 30px"></div>
                  ...
                  <div contenteditable="false" class="d-flex" style="margin-left : 30px;">
                    <div style="width: 16px; height: 16px; border: 1px solid black; margin-left : 5px;  margin-right : 5px; margin-top : 4px;">
    ...
    openContractPaper() {
      ...
      if (!this.isContractOpen) {
        createInstance().get('/contracts?projectId=' + this.projectId + '&userId=' + String(this.id_),
          ...
          if (tmp.length === 32) document.querySelector('#' + this.imgSign).src = tmp[31]
        })
