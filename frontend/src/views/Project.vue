<template>
  <b-container>
    ...
    <div class="text-center">
      <div @click="clickPageOne" id="page1" class="d-inline-block fw-bold mx-2 activePage pageItem" >1</div>
      <div @click="clickPagetwo" id="page2" class="d-inline-block fw-bold mx-2 pageItem" >2</div>
      <div @click="clickPagethree" id="page3" class="d-inline-block fw-bold mx-2 pageItem" >3</div>
      <div @click="clickPagefour" id="page4" class="d-inline-block fw-bold mx-2 pageItem" >4</div>
      <div @click="clickPagefive" id="page5" class="d-inline-block fw-bold mx-2 pageItem" >5</div>
      <div @click="clickPagesix" id="page6" class="d-inline-block fw-bold mx-2 pageItem" >6</div>
      <div @click="clickPageseven" id="page7" class="d-inline-block fw-bold mx-2 pageItem" >7</div>
      <div @click="clickPageeight" id="page8" class="d-inline-block fw-bold mx-2 pageItem" >8</div>
      <div @click="clickPagenine" id="page9" class="d-inline-block fw-bold mx-2 pageItem" >9</div>
      <div @click="clickPageten" id="page10" class="d-inline-block fw-bold mx-2 pageItem" >10</div>
    </div>
    ...
    methods : {
      applyFilter(value) {
        ...
        createInstance().get('/project/filter/', {
          ...
          this.projectCardMap.push(tmp)
          this.isFilter = true
          if (parseInt(this.projectCardTotal/6) != this.projectCardTotal.length/6) { 
          ...
          for (let t = 1; t < 11; t++) {
            ...
            if (document.querySelector('#page' + String(t)).classList.contains('activePage'))
              document.querySelector('#page' + String(t)).classList.remove('activePage')
            if (document.querySelector('#page' + String(t)).classList.contains('d-none')) {
              document.querySelector('#page' + String(t)).classList.remove('d-none')
            }
          }
          document.querySelector('#page1').classList.add('activePage')
          for (let t = this.filterIdx; t < 11; t++) document.querySelector('#page' + String(t)).classList.add('d-none')
        })
      },
      ...
      clickPageOne() {
        ...
        for (let i = 0; i < tmp.length; i++) {
          if (tmp[i].classList.contains('activePage')) tmp[i].classList.remove('activePage')
        }
        document.querySelector('#page1').classList.add('activePage')
        this.btnIdx = 1
      ...
      clickNextBtnProject() {
        ...
        if (this.limitIdx === -1 || this.idx + 2< this.filterIdx) {
          document.querySelector('#page' + this.btnIdx).classList.remove('activePage')
          this.idx++
          this.btnIdx++
          if (this.btnIdx === 11) {
            ...
            for (let i = 0; i < btnTmp.length; i++) {
              ...
              if (this.filterIdx != -1 && parseInt(btnTmp[i].innerText) >= this.filterIdx) {
